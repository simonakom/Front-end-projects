...
<h4 style="font-size: 16px;border-bottom: 1px solid black;">HTML/CSS<h4> 
...
<p style="font-size: 16px;border-bottom: 1px solid black;">Bootsrap<p> 
...
<p style="font-size: 16px;border-bottom: 1px solid black;">JavaScript<p> 
